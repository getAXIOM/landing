  ...
  useEffect(() => {
    const onScroll = () => {
      if (titleRef.current && subtitleRef.current) {
        ...
        subtitleRef.current.style.transform = `translateY(${scrollPosition * 0.1}px)`;
      }
    };
    ...
    >
      ...
      <div className="container mx-auto px-4 py-32 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <span className="block text-transparent bg-clip-text gradient-text-white pb-2">A is for AXIOM</span>
            <span className="block text-2xl md:text-3xl lg:text-4xl mt-3 font-light">your home sweet home</span>
          </h1>
          ...
          >
            The jewel of the BnL fleet - the AXIOM. The search engine of 2028 has arrived today.
          </p>
